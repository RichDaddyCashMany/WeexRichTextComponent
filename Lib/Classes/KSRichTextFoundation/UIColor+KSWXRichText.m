...
@implementation UIColor (KSWXRichText)
...
UIColor *UIColorCreateWithHTMLName(NSString *name) {
    if ([name hasPrefix:@"#"]) {
        return UIColorCreateWithHexString([name substringFromIndex:1]);
    }
    ...
    return UIColorCreateWithHexString(hexString);
}
